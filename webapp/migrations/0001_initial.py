# Generated by Django 3.2.3 on 2023-05-14 13:49
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('mech', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='active_pilot', to='webapp.mech')),
                ('status', models.IntegerField(choices=[(0, 'Not Available'), (1, 'Available')], default=0)),
                ('slug', models.SlugField(max_length=200, unique=True)),
            ],
        ),
